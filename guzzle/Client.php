...
class Client extends AbstractHasDispatcher implements ClientInterface
{
    ...
    {
        $opts = $this->config[self::CURL_OPTIONS] ?: [];
     ...
     */
    protected function prepareRequest(RequestInterface $request, array $options = [])
    {
        ...
        $this->dispatch('client.create_request', ['client' => $this, 'request' => $request]);
