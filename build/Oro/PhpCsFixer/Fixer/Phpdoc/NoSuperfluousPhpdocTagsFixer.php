...
namespace Oro\PhpCsFixer\Fixer\Phpdoc;
...
/**
 * Removes PHPDoc param and return tags is there is no extra information in any param and return tags.
 * Inspired by {@see \PhpCsFixer\Fixer\Phpdoc\NoSuperfluousPhpdocTagsFixer}.
 *
...
final class NoSuperfluousPhpdocTagsFixer extends AbstractFixer implements ConfigurationDefinitionFixerInterface
{
    ...
    {
        return 'Oro/no_superfluous_phpdoc_tags';
    }
...
',
     ...
     * Must run after AlignMultilineCommentFixer, CommentToPhpdocFixer, FullyQualifiedStrictTypesFixer,
     * PhpdocAddMissingParamAnnotationFixer, PhpdocIndentFixer, PhpdocReturnSelfReferenceFixer, PhpdocScalarFixer,
     * PhpdocToCommentFixer, PhpdocToParamTypeFixer, PhpdocToReturnTypeFixer, PhpdocTypesFixer.
     */
    ...
    private function fixFunctionDocComment($content, Tokens $tokens, $functionIndex, array $shortNames)
    {
        ...
        $closingParenthesisIndex = $tokens->findBlockEnd(
