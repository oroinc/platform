...
<?php if ($action !== null) $options = array_merge($options, ['action' => $action]); ?>

<?php if (isset($form_method) && !in_array($form_method, ['GET', 'POST'])) $form_method = 'POST'; ?>

<?php if (isset($form_multipart)) $options = array_merge($options, ['multipart' => $form_multipart]); ?>
