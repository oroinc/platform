...
{
    public const string ROOT_NODE = 'oro_form';
    public const string WYSIWYG_ENABLED = 'wysiwyg_enabled';
    public const string ENABLED_CAPTCHA = 'enabled_captcha';
    public const string CAPTCHA_SERVICE = 'captcha_service';
    public const string CAPTCHA_PROTECTED_FORMS = 'captcha_protected_forms';
    public const string USE_CAPTCHA_FOR_LOGGED_IN = 'use_captcha_for_logged_in';

    public const string RECAPTCHA_PUBLIC_KEY = 'recaptcha_public_key';
    public const string RECAPTCHA_PRIVATE_KEY = 'recaptcha_private_key';
    public const string RECAPTCHA_MINIMAL_ALLOWED_SCORE = 'recaptcha_minimal_allowed_score';

    public const string HCAPTCHA_PUBLIC_KEY = 'hcaptcha_public_key';
    public const string HCAPTCHA_PRIVATE_KEY = 'hcaptcha_private_key';

    public const string TURNSTILE_PUBLIC_KEY = 'turnstile_public_key';
