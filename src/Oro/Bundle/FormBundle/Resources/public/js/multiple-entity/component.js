...
import CallbackListener from 'orodatagrid/js/datagrid/listener/callback-listener';
import WidgetManager from 'oroui/js/widget-manager';
import MultipleEntityModel from 'oroform/js/multiple-entity/model';
...
export default MultipleEntityComponent;
