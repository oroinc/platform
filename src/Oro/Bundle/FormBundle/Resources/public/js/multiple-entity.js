...
import EntityView from './multiple-entity/view';
import DialogWidget from 'oro/dialog-widget';
import template from 'tpl-loader!oroform/js/multiple-entity/templates/multiple-entities.html';
import elementTemplate from 'tpl-loader!oroform/js/multiple-entity/templates/multiple-entity.html';
const $ = Backbone.$;
...
export default MultipleEntityView;
