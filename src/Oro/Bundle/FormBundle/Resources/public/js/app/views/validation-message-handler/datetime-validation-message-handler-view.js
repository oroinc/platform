import $ from 'jquery';
import AbstractValidationMessageHandlerView
    from 'oroform/js/app/views/validation-message-handler/abstract-validation-message-handler-view';
...
export default DateTimeValidationMessageHandlerView;
