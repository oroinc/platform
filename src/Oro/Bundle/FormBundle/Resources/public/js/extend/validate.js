...
import validationHandler from 'oroform/js/optional-validation-groups-handler';
import error from 'oroui/js/error';
import moduleConfig from 'module-config';
const config = moduleConfig(module.id);
let validateTopmostLabelMixin = null;
if (config.useTopmostLabelMixin) {
    validateTopmostLabelMixin = (await import('oroform/js/validate-topmost-label-mixin')).default;
}
import messageTemplate from 'tpl-loader!oroform/templates/error-template.html';
