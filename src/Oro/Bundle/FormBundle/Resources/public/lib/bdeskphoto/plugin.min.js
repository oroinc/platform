                ...
                onclick: function () {
                    if (window.File && window.FileReader && window.FileList && window.Blob) {
                        ...
                        class_filereader.onload = function (base64) {
                            ...
                            var img = new Image();
                            var altVal = imagefile[0].name.split('.')[0];
                            img.src = imgData;

                            editor.execCommand("mceInsertContent", false, "<img src='" + imgData + "' alt=" + altVal +" >");
                        };
