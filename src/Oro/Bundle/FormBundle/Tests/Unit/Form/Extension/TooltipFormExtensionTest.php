...
class TooltipFormExtensionTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testModifyEntityConfigTooltipFieldWithMessagesTranslationDomain()
    {
        $tooltip = 'Custom Tooltip';
    ...
    public function testModifyEntityConfigTooltipFieldWithTooltipTranslationDomain()
    {
        $tooltip = 'Custom Tooltip';
