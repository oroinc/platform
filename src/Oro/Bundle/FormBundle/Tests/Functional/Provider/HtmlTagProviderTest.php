...
class HtmlTagProviderTest extends WebTestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->allowedTags = '<table></table><thead></thead><tbody></tbody><tr></tr><td></td><th></th><a></a>' .
            ...
            '<dd></dd><del></del><details></details><dfn></dfn><figure></figure><figcaption></figcaption><picture></picture>' .
            '<footer></footer><header></header><hr></hr><ins></ins><kbd></kbd><mark></mark><menu></menu><nav></nav>' .
            '<pre></pre><q></q><samp></samp><section></section><small></small><source></source><sub></sub><sup></sup>' .
            '<time></time><tfoot></tfoot><var></var><video></video><aside></aside>';
    }
