...
class EntityClassResolverTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetEntityClassByTableName()
    {
        ...
        $metadata->expects($this->once())
            ...
            ->will(
                $this->returnValue(
                    new \ReflectionClass('Oro\Bundle\EntityBundle\Tests\Unit\ORM\Fixtures\TestEntity')
                )
            );
        ...
        $this->assertEquals(
            ...
            $this->resolver->getEntityClassByTableName('acme_test')
        );
    }
    ...
    public function testGetFieldNameByColumnName()
    {
        ...
        $this->assertEquals(
            'name_field',
            $this->resolver->getFieldNameByColumnName('acme_test', 'name_column')
        );
    }
