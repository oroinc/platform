...
{
    public function testCreateRecurringEventWithAttendeesAndExceptionCanceledAndDeletedCorrectly()
    {
        ...
        $mainExceptionEvent = $this->addRecurringEventExceptionForCalendarEvent(
            $mainCalendarEvent,
            $exceptionStart,
            $exceptionEnd,
            '2016-02-13T09:00:00+00:00'
        );
        ...
        $this->updateCalendarEventViaAPI($mainExceptionEvent->getId(), ['isCancelled' => true]);
