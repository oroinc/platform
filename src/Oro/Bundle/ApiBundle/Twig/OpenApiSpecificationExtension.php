...
class OpenApiSpecificationExtension extends AbstractExtension implements ServiceSubscriberInterface
{
    ...
    public function getFilters(): array
    {
        return [
            ...
            new TwigFilter('oro_open_api_entities', [$this, 'getOpenApiEntities'], ['is_safe' => ['html']])
        ];
    }
    ...
    {
        return [
            OpenApiChoicesProvider::class,
            ValueNormalizer::class,
            EntityNameProvider::class,
            RestDocViewDetector::class,
    ...
    {
        return $this->container->get(OpenApiChoicesProvider::class);
    }

    private function getValueNormalizer(): ValueNormalizer
    {
        return $this->container->get(ValueNormalizer::class);
    }

    private function getEntityNameProvider(): EntityNameProvider
    {
        return $this->container->get(EntityNameProvider::class);
    }

    private function getDocViewDetector(): RestDocViewDetector
    {
        return $this->container->get(RestDocViewDetector::class);
    }
