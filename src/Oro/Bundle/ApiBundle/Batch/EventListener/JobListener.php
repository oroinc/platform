...
class JobListener
{
    ...
    public function setAsyncOperationManager(AsyncOperationManager $asyncOperationManager)
    {
    ...
    public function onBeforeSaveJob(BeforeSaveJobEvent $event): void
    {
        ...
        $operation = $this->doctrineHelper->getEntityManagerForClass(AsyncOperation::class)
