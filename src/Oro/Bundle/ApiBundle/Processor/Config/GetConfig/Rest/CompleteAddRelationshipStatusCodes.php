...
/**
 * Adds possible status codes for the "add_relationship" action executed in scope of REST API.
 */
class CompleteAddRelationshipStatusCodes extends CompleteStatusCodes
{
    /**
     * {@inheritdoc}
     */
