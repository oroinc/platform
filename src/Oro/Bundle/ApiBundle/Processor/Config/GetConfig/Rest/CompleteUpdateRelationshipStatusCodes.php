...
/**
 * Adds possible status codes for the "update_relationship" action executed in scope of REST API.
 */
class CompleteUpdateRelationshipStatusCodes extends CompleteStatusCodes
{
    /**
     * {@inheritdoc}
     */
