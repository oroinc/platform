...
class NormalizeIncludedData implements ProcessorInterface
{
    ...
    public function setUpsertCriteriaBuilder(UpsertCriteriaBuilder $upsertCriteriaBuilder): void
    {
        $this->upsertCriteriaBuilder = $upsertCriteriaBuilder;
    }

    public function setEntityIdHelper(EntityIdHelper $entityIdHelper): void
    {
    ...
    private function loadIncludedEntity(
        ...
        if (null !== $entity) {
            $includedEntityData = new IncludedEntityData($pointer, $index, $isExistingEntity);
            $includedEntityData->setTargetAction($targetAction);
