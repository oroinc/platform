...
/**
 * Dispatches "pre_validation" event for all included entities forms.
 */
class PreValidateIncludedForms implements ProcessorInterface
{
    ...
    public function process(ContextInterface $context): void
    {
        ...
        foreach ($includedEntities as $includedEntity) {
            ...
            if (null !== $includedForm && $includedForm->isSubmitted()) {
                $this->validator->preValidate($includedForm);
            }
        }
    }
}
