...
/**
 * Registers services tagged by "oro.api.error_completer" tag.
 */
class ErrorCompleterConfigurationCompilerPass implements CompilerPassInterface
{
    const ERROR_COMPLETER_REGISTRY_SERVICE_ID = 'oro_api.error_completer_registry';
    const ERROR_COMPLETER_TAG                 = 'oro.api.error_completer';
