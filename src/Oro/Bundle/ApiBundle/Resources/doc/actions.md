...
You can change this limit for an entity in `Resources/config/oro/acl.yml`, but please test your limit carefully because a big limit may make a big impact to the server.
