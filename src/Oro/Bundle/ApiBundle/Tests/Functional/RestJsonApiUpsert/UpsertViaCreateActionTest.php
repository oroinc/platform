...
class UpsertViaCreateActionTest extends RestJsonApiTestCase
{
    ...
    public function testTryToWhenEntityExistsAndRequestDataHasValidationErrors(): void
    {
        $entityType = $this->getEntityType(TestCustomIdentifier::class);
        $response = $this->post(
            ['entity' => $entityType],
    ...
    public function testTryToWhenEntityDoesNotExistAndRequestDataHasValidationErrors(): void
    {
        $entityType = $this->getEntityType(TestCustomIdentifier::class);
        $response = $this->post(
            ['entity' => $entityType],
