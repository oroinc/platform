...
use Oro\Bundle\ApiBundle\Tests\Functional\Environment\Entity\TestCustomCompositeIdentifier as TestEntity;

/**
 * @dbIsolationPerTest
 */
class RestJsonApiCustomCompositeIdentifierTest extends RestJsonApiTestCase
{
    /**
     * {@inheritdoc}
     */
    protected function setUp()
    {
        ...
        $this->loadFixtures([
            '@OroApiBundle/Tests/Functional/DataFixtures/custom_composite_identifier.yml'
        ]);
    }
    ...
    {
        return http_build_query(['key1' => $key1, 'key2' => $key2], '', EntityIdTransformer::COMPOSITE_ID_SEPARATOR);
    }
    ...
    public function testGetListSortByDatabasePrimaryKey()
    {
        $entityType = $this->getEntityType(TestEntity::class);

        $response = $this->cget(
            ['entity' => $entityType],
            ['sort' => '-databaseId', 'fields[' . $entityType . ']' => 'id']
        );
    ...
    public function testGetListFilterByIdWithNotEqualOperator()
    {
        $entityType = $this->getEntityType(TestEntity::class);
    ...
    public function testGetListFilterBySeveralIdsWithNotEqualOperator()
    {
        $entityType = $this->getEntityType(TestEntity::class);
