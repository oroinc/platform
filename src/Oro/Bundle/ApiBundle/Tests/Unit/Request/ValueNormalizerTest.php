...
class ValueNormalizerTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function normalizeValueProvider(): array
    {
        return [
            ...
            ['123.1', '123.10', DataType::DECIMAL, [RequestType::REST], true],
            ['123.1', '123.10', DataType::DECIMAL, [RequestType::REST], false],
            ['123.0', '123.0', DataType::DECIMAL, [RequestType::REST], true],
            ['123.0', '123.0', DataType::DECIMAL, [RequestType::REST], false],
            ['-123.0', '-123', DataType::DECIMAL, [RequestType::REST], true],
            ['-123.0', '-123', DataType::DECIMAL, [RequestType::REST], false],
            ['-123.1', '-123.1', DataType::DECIMAL, [RequestType::REST], true],
            ['-123.1', '-123.1', DataType::DECIMAL, [RequestType::REST], false],
            [['123.1', '-456.0'], '123.1,-456', DataType::DECIMAL, [RequestType::REST], true],
            ...
            ['0.0', '0', DataType::MONEY, [RequestType::REST], true],
            ['0.0', '0', DataType::MONEY, [RequestType::REST], false],
            ['123.0', '123', DataType::MONEY, [RequestType::REST], true],
            ['123.0', '123', DataType::MONEY, [RequestType::REST], false],
            ...
            ['123.1', '123.1000', DataType::MONEY, [RequestType::REST], true],
            ['123.1', '123.1000', DataType::MONEY, [RequestType::REST], false],
            ['-123.0', '-123', DataType::MONEY, [RequestType::REST], true],
            ['-123.0', '-123', DataType::MONEY, [RequestType::REST], false],
            ['-123.1', '-123.1', DataType::MONEY, [RequestType::REST], true],
            ['-123.1', '-123.1', DataType::MONEY, [RequestType::REST], false],
            [['123.1', '-456.0'], '123.1,-456', DataType::MONEY, [RequestType::REST], true],
