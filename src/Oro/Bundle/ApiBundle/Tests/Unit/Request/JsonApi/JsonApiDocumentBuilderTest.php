...
class JsonApiDocumentBuilderTest extends DocumentBuilderTestCase
{
    ...
    public function testAssociationWithMetaPropertiesInTargetMetadata()
    {
        ...
        foreach ($metadata->getAssociations() as $association) {
            ...
            $metaProperty1 = new MetaPropertyMetadata('meta1');
            $metaProperty1->setDataType('string');
            $metaProperty1->setPropertyPath('_meta1');
            $associationTargetMetadata->addMetaProperty($metaProperty1);
            $metaProperty2 = new MetaPropertyMetadata('meta2');
            $metaProperty2->setDataType('string');
            $associationTargetMetadata->addMetaProperty($metaProperty2);
        }
