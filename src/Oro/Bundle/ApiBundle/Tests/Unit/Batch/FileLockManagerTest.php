...
class FileLockManagerTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->fileLockManager = new FileLockManager($this->createMock(ManagerRegistry::class), 'message_queue');
        $this->fileLockManager->setLockFactory($this->lockFactory);
        $this->fileLockManager->setLogger($this->logger);
    }
