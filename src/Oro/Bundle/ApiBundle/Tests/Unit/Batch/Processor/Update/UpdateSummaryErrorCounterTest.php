...
{
    private RetryHelper&MockObject $retryHelper;
    private UpdateSummaryErrorCounter $processor;
    ...
    public function testProcessWhenItemHasErrorsToSave(): void
    {
        $rawItems = [['key' => '1']];
    ...
    public function testProcessWhenItemDoesNotHaveErrorsToSave(): void
    {
        $rawItems = [['key' => '1']];
        $processedItemStatuses = [0];
        $hasItemsToRetry = true;
