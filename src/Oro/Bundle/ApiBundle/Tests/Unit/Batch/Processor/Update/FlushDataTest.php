...
class FlushDataTest extends BatchUpdateProcessorTestCase
{
    ...
    public function testProcessWhenNoBatchItemsInContext(): void
    {
        $this->flushDataHandlerFactoryRegistry->expects(self::never())
            ->method('getFactory');
        $this->flushDataHandlerFactory->expects(self::never())
    ...
    public function testProcessWhenExceptionOccurredInFlushDataAndSeveralBatchItemsInContext(): void
    {
        $operationId = 123;
    ...
    public function testProcessWhenUniqueConstraintViolationExceptionOccurredInFlushDataAndSeveralItemsInContext(): void
    {
        $item1 = $this->getBatchUpdateItem(0);
        $item2 = $this->getBatchUpdateItem(1);
        $item1->getContext()->setClassName(self::ENTITY_CLASS);
    ...
    public function testProcessWhenExceptionOccurredInFlushDataAndOneBatchItemsInContext(): void
    {
        $operationId = 123;
        $chunkFileName = 'test.json';
    ...
    public function testProcessWhenUniqueConstraintViolationExceptionOccurredInFlushDataAndOneItemInContext(): void
    {
        $item1 = $this->getBatchUpdateItem(0);
        $item1->getContext()->setClassName(self::ENTITY_CLASS);
        $items = [$item1];
