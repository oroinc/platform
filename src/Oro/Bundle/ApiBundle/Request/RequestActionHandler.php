...
abstract class RequestActionHandler
{
    ...
    {
        $this->logRequest(ApiAction::UPDATE_SUBRESOURCE, $request, true);
    ...
    {
        $this->logRequest(ApiAction::ADD_SUBRESOURCE, $request, true);
    ...
    {
        $this->logRequest(ApiAction::DELETE_SUBRESOURCE, $request, true);
