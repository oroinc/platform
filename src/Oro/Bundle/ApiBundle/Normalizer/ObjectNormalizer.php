...
class ObjectNormalizer
{
    ...
    public function setAssociationAccessExclusionProviderRegistry(
        AssociationAccessExclusionProviderRegistry $registry
    ): void {
        $this->associationAccessExclusionProviderRegistry = $registry;
    }
