...
class WebsocketServerSharedStateManager implements WebsocketServerStateManagerInterface
{
    ...
    public function updateState(string $stateId): \DateTimeInterface
    {
        ...
        $sql = $this->getUpsertSql($connection->getDatabasePlatform() instanceof MySQLPlatform);
    ...
    private function getUpsertSql(bool $isMySQL): string
    {
        if ($isMySQL) {
            return 'INSERT INTO oro_sync_websocket_server_state (id, updated_at) VALUES (:id, :date)
