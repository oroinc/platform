...
{
    private NodeProcessFactory|MockObject $nodeProcessFactory;
    ...
    {
        $this->nodeProcessFactory = $this->createMock(NodeProcessFactory::class);
    ...
    public function testWebPackBuildOnEachThemeSeparately()
    {
        ...
        $this->nodeProcessFactory->expects(self::exactly(3))
            ->method('create')
