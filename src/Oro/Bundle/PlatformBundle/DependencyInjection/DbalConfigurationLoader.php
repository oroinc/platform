...
class DbalConfigurationLoader
{
     ...
     * @return array
     */
    private static function getCommonDbalConfig(array $doctrineConfig)
    {
        /**
     ...
     * @return bool
     */
    private static function hasCommonDbalConfig(array $config)
    {
        /**
         * @see \Doctrine\Bundle\DoctrineBundle\DependencyInjection\Configuration::addDbalSection
         */
     ...
     * @return string|null
     */
    private static function getDefaultDbalConnectionName(array $doctrineConfig)
    {
     ...
     * @return string[]
     */
    private static function getDbalConnectionNames(array $doctrineConfig)
    {
        $connectionNames = [];
        foreach ($doctrineConfig as $config) {
     ...
     * @return string|null
     */
    private static function getDbalConnectionKey(array $doctrineConfig, $connectionName)
    {
        $driver = '';
        $dbname = '';
        $host = '';
     ...
     * @return array|null
     */
    private static function getDbalConnections(array $dbalConfig)
    {
