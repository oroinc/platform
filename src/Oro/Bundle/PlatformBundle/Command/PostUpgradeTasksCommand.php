...
{
    protected static $defaultName = 'oro:platform:post-upgrade-tasks';
    protected static $defaultDescription = 'Schedules background jobs to fix data asynchronously after upgrade.';
