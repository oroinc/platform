...
class JmsSerializerPassTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testProcessWhenJmsSerializerBundleIsInstalled(): void
    {
        ...
        self::assertEquals(
            'Oro\Bundle\PlatformBundle\Twig\SerializerExtension',
            $serializerTwigExtension->getClass()
        );
        self::assertEquals(
        ...
        $jmsSerializerCacheAdapterDef = (new Definition('Metadata\Cache\DoctrineCacheAdapter'))
            ->setPublic(false)
            ->setArguments([
