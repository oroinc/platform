...
{
    private ThemeConfigurationTypeProvider&MockObject $themeConfigurationTypeProvider;
    private ThemeConfigurationTypeExtension $extension;
    private ThemeConfigurationType $type;
    ...
    protected function setUp(): void
    {
        ...
        $this->themeConfigurationTypeProvider = $this->createMock(ThemeConfigurationTypeProvider::class);
        $this->themeConfigurationTypeProvider
            ->method('getLabelsAndTypes')
            ->willReturn(['Default' => 'default', 'Custom' => 'custom']);

        $this->extension = new ThemeConfigurationTypeExtension($this->themeConfigurationTypeProvider);
    ...
    public function testBuildForm(): void
    {
        ...
        self::assertEquals('oro.theme.themeconfiguration.type.label', $typeField->getConfig()->getOption('label'));
        self::assertTrue($typeField->getConfig()->getOption('required'));
        self::assertEquals(
