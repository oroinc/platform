...
class FileManagerTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->externalFileFactory = $this->getMockBuilder(ExternalFileFactory::class)
            ->disableOriginalConstructor()
            ->onlyMethods(['createFromUrl'])
            ->getMock();
        ...
        $this->fileManager->setExternalFileFactory($this->externalFileFactory);
    ...
    public function testGetFileFromFileEntityWhenExternalUrls(): void
    {
        ...
        $externalFile = new ExternalFile($fileEntity->getExternalUrl(), 'testFile.txt');

        self::assertEquals($externalFile, $this->fileManager->getFileFromFileEntity($fileEntity, false));
    }
    ...
    public function testPreUploadForExternalFile(): void
    {
        ...
        $fileEntity->setExternalFile($externalFile);
