...
class ImageResizeManagerTest extends \PHPUnit\Framework\TestCase
{
    ...
    /** @var ImageResizer|\PHPUnit\Framework\MockObject\MockObject */
    private $imageResizer;

    /** @var ThumbnailFactory|\PHPUnit\Framework\MockObject\MockObject */
    ...
    public function testResizeWhenFails(string $rawResizedImage, bool $forceUpdate): void
    {
        ...
        $this->fileManager
            ...
            ->method('getContent')
            ->with($file, false)
            ->willReturn($rawImageContent = 'sample-raw-content');

        $this->thumbnailFactory
            ->expects(self::once())
            ->method('createThumbnail')
            ->with($rawImageContent)
     ...
     * @param bool $forceUpdate
     */
    public function testResizeWhenNoOriginalFile(string $rawResizedImage, bool $forceUpdate): void
    {
        $this->mockMediaCacheManager($file = new File(), $rawResizedImage);
