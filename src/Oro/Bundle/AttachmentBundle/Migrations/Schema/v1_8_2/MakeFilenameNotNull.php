...
namespace Oro\Bundle\AttachmentBundle\Migrations\Schema\v1_8_2;
...
/**
 * Make filename and original_filename NOT NULL
 * Remove broken records where filename IS NULL
 */
