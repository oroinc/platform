...
import CellIterator from '../../../datagrid/cell-iterator';
import ApiAccessor from 'oroui/js/tools/api-accessor';
import Modal from 'oroui/js/modal';
import SplitEventList from './inline-editing-plugin/split-event-list';
import pageStateChecker from 'oronavigation/js/app/services/page-state-checker';
import 'orodatagrid/js/app/components/cell-popup-editor-component';
import 'oroform/js/app/views/editor/text-editor-view';
...
export default InlineEditingPlugin;
