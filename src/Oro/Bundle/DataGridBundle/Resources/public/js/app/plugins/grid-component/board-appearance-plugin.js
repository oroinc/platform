...
import collectionTools from 'oroui/js/tools/collection-tools';
import loadModules from 'oroui/js/app/services/load-modules';
import BoardDataCollection from '../../models/board-data-collection';
...
export default BoardAppearancePlugin;
