define(['underscore'], function(_) {
     ...
     * @constructor
     */
    function DynamicEventList(Ctor, testFnName, extendedEvents) {
        this.Ctor = Ctor;
        this.extendedEvents = extendedEvents;
        this.testFnName = testFnName;
        this.canGenerateEventsAsObject = !_.isFunction(Ctor.prototype.events);
    }

    DynamicEventList.prototype = {
        ...
        generateEvents: function(view) {
            var oldEvents = this.canGenerateEventsAsObject ?
                this.Ctor.prototype.events :
                this.Ctor.prototype.events.call(view);
