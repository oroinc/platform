...
import previewElementTemplate from 'tpl-loader!orodigitalasset/templates/digital-asset-choose-form/preview.html';

const DigitalAssetChooseFormView = BaseView.extend({
    previewElementTemplate,
    autoRender: true,
...
export default DigitalAssetChooseFormView;
