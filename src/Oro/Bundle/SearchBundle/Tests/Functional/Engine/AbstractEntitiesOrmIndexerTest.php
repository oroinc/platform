...
abstract class AbstractEntitiesOrmIndexerTest extends WebTestCase
{
    ...
    private function getSearchableEntitiesInPackage(): array
    {
        ...
        return \array_filter($allSearchableEntities, function ($entityClass) use ($bundleNamespaces) {
            return \array_any($bundleNamespaces, static fn ($namespace) => \str_starts_with($entityClass, $namespace));
        });
    }
