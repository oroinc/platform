...
trait SearchExtensionTrait
{
    ...
    {
        self::getContainer()->get('oro_search.search.engine.indexer')->resetIndex($class, $context);
    }
    ...
    {
        self::getContainer()->get('oro_search.search.engine.indexer')->reindex($class, $context);
    }
}
