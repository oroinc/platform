...
namespace Oro\Bundle\EntityExtendBundle\Tests\Unit\Form\Handler;
...
use Oro\Bundle\EntityExtendBundle\Form\Handler\CreateUpdateConfigFieldHandler;
...
class CreateUpdateConfigFieldHandlerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testHandleFieldSaveWhenMethodIsPostAndFormIsValid()
    {
        ...
        $redirectResponse = $this->expectsConfigSavingAndRedirect($request, $newFieldModel, $extendEntityConfig);
