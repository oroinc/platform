...
class ExtendFieldTypeGuesserTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->guesser->setExtendFieldFormTypeProvider($this->extendFieldFormTypeProvider);
        $this->guesser->setExtendFieldFormOptionsProvider($this->extendFieldFormOptionsProvider);
    }
