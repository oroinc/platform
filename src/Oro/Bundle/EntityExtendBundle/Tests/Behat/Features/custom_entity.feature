...
Feature: Custom entity
  In order to manage data of custom fields
  As an Administrator
  I want to have possibility to create custom entity with extended fields
  ...
  Scenario: Remove custom entity
    ...
    And filter Name as is equal to "testcustomentity"
    When I click Remove "testcustomentity" in grid
