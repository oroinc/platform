...
Feature: Correct create schema with deleted new field
  ...
  Scenario: Delete new field w/o update schema and check schema
    ...
    And check if field "default_test1_id" "not" in db table by entity class "Oro\Bundle\UserBundle\Entity\User"
  ...
  Scenario: Delete new field after update schema and check schema
    ...
    And check if field "default_test1_id" "is" in db table by entity class "Oro\Bundle\UserBundle\Entity\User"
