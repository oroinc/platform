 ...
 *      label="oro.entity_extend.attribute.manage",
 *      type="action",
 *      group_name=""
 * )
 */
class AttributeController extends Controller
{
     ...
     *      label="oro.entity_extend.attribute.create",
     *      type="action",
     *      group_name=""
     * )
     * @Template
     ...
     * Acl(
     *      id="oro_attribute_save",
     *      label="oro.entity_extend.attribute.create",
     *      type="action",
     *      group_name=""
     * )
     * @Template("OroEntityExtendBundle:Attribute:update.html.twig")
     * @param Request $request
     * @param string $alias
     * @return array|\Symfony\Component\HttpFoundation\RedirectResponse
     */
    public function saveAction(Request $request, $alias)
    {
        ...
        $successMessage = $this->get('translator')->trans('oro.entity_extend.attribute.successfully_saved');
     ...
     *      label="oro.entity_extend.attribute.update",
     *      type="action",
    ...
    private function ensureEntityConfigSupported(EntityConfigModel $entityConfigModel)
    {
        ...
        if (!$extendConfig->is('is_extend') || !$attributeConfig->is('has_attributes')) {
            throw new BadRequestHttpException(
                $this->get('translator')->trans('oro.entity_extend.attribute.entity_not_supported')
            );
        }
    }
    ...
    private function ensureFieldConfigSupported(FieldConfigModel $fieldConfigModel)
    {
        ...
        if (!$attributeConfig->is('is_attribute')) {
            throw new BadRequestHttpException(
                $this->get('translator')->trans('oro.entity_extend.attribute.not_attribute')
            );
        }
    }
    ...
    public function removeAction(FieldConfigModel $field)
    {
        ...
        $successMessage = $this->get('translator')->trans('oro.entity_extend.attribute.successfully_deleted');
    ...
    public function unremoveAction(FieldConfigModel $field)
    {
        ...
        return $this->get('oro_entity_extend.form.handler.remove_restore_field_handler')
            ->handleRestore(
                $field,
                $this->get('translator')->trans('oro.entity_extend.attribute.cannot_be_restored'),
                $this->get('translator')->trans('oro.entity_extend.attribute.was_restored')
            );
    }
}
