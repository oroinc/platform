...
class ExtendFieldConfiguration implements FieldConfigInterface
{
    ...
    public function configure(NodeBuilder $nodeBuilder): void
    {
        $nodeBuilder
            ...
            ->node('is_deleted', 'normalized_boolean')->end()
            ->arrayNode('relation')
                ->ignoreExtraKeys()
            ->end()
            ->node('bidirectional', 'normalized_boolean')->end()
            ...
            ->scalarNode('fetch')
                ...
                'and ‘eager’.')
            ->end()
            ->node('nullable', 'normalized_boolean')->end()
            ...
            ->node('orphanRemoval', 'normalized_boolean')
                ...
                'documentation for more details.')
            ->end()
            ->node('default', 'normalized_boolean')->end()
