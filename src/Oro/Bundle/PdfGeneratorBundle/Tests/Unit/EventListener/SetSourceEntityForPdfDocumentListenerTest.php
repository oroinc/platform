...
final class SetSourceEntityForPdfDocumentListenerTest extends TestCase
{
    ...
    public function testPostFlushSkipsDocumentNotContainedInEntityManager(): void
    {
        ...
        $event = new AfterPdfDocumentCreatedEvent($pdfDocument, $pdfDocumentDemand, 'instant');
    ...
    public function testPostFlushWithMultipleDocuments(): void
    {
        ...
        $event1 = new AfterPdfDocumentCreatedEvent($pdfDocument1, $pdfDocumentDemand1, 'instant');
        ...
        $event2 = new AfterPdfDocumentCreatedEvent($pdfDocument2, $pdfDocumentDemand2, 'instant');
