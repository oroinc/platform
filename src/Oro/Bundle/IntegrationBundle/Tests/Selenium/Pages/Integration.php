...
class Integration extends AbstractPageEntity
{
    ...
    {
        $field = $this->test->byXpath("//*[starts-with(@id,'oro_integration_channel_form_name')]");
        $field->clear();
        $field->value($name);
    ...
    {
        $field = $this->test->select($this->test->byXpath("//*[starts-with(@id,'oro_integration_channel_form_type')]"));
