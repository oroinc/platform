...
/**
 * Update field database type for oro_integration_channel_status.data fields on mysql 5.7 to use native JSON
 */
class UpdateJsonArrayQuery extends ParametrizedMigrationQuery
{
    ...
    public function doExecute(LoggerInterface $logger, $dryRun = false)
    {
        ...
        if ($platform instanceof MySQL57Platform) {
            $updateSql = "ALTER TABLE oro_integration_channel_status " .
                "CHANGE data data JSON DEFAULT NULL COMMENT '(DC2Type:json)'";
