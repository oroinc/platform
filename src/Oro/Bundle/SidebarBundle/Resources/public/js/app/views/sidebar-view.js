...
import WidgetPickerModal from 'orosidebar/js/app/views/widget-picker-modal-view';
import WidgetSetupModalView from 'orosidebar/js/app/views/widget-setup-modal-view';
import ScrollingOverlay from 'oroui/js/app/views/scrolling-overlay-view';
import constants from 'orosidebar/js/sidebar-constants';
import template from 'tpl-loader!orosidebar/templates/sidebar.html';
import itemView from 'orosidebar/js/app/views/sidebar-widget-container/widget-container-view';
