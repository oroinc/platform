...
/**
 * Update field database type for oro_report.chart_options field on mysql 5.7 to use native JSON
 */
class UpdateJsonArrayQuery extends ParametrizedMigrationQuery
{
    ...
    public function doExecute(LoggerInterface $logger, $dryRun = false)
    {
        ...
        if ($platform instanceof MySQL57Platform) {
            $updateSql = "ALTER TABLE oro_report ".
                "CHANGE chart_options chart_options JSON DEFAULT NULL COMMENT '(DC2Type:json_array)'";
