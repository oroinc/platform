...
class ImportExportController extends AbstractController
{
    ...
    #[AclAncestor('oro_importexport_import')]
    #[CsrfProtection()]
    public function importValidateAction(Request $request, $processorAlias): JsonResponse
    {
    ...
    #[CsrfProtection()]
    public function importProcessAction(Request $request, $processorAlias): JsonResponse
    {
    ...
    #[AclAncestor('oro_importexport_export')]
    #[CsrfProtection()]
    public function instantExportAction($processorAlias, Request $request): Response
    {
    ...
    #[AclAncestor('oro_importexport_import')]
    public function templateExportAction($processorAlias, Request $request): Response
    {
