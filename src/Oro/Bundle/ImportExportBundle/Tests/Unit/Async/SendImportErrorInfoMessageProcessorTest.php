...
use Oro\Bundle\ImportExportBundle\Async\SendImportErrorInfoMessageProcessor;
 ...
 */
class SendImportErrorInfoMessageProcessorTest extends \PHPUnit_Framework_TestCase
{
    public function testSendImportNotificationProcessCanBeConstructedWithRequiredAttributes()
    {
        $chunkHttpImportMessageProcessor = new SendImportErrorInfoMessageProcessor(
    ...
    {
        $expectedSubscribedTopics = [Topics::SEND_IMPORT_ERROR_INFO];
        $this->assertEquals(
            $expectedSubscribedTopics,
            SendImportErrorInfoMessageProcessor::getSubscribedTopics()
        );
    }
    ...
    public function testShouldLogErrorAndRejectMessageIfMessageWasInvalid()
    {
        ...
        $processor = new SendImportErrorInfoMessageProcessor(
            $this->createMessageProducerInterfaceMock(),
            $logger,
            $this->createConfigManagerMock(),
            $this->createDoctrineMock()
        ...
        $producer
            ...
            ->with(
                ...
                [
                    ...
                    'subject' => 'Error importing file import.csv',
                    'body' => 'The import file could not be imported due to a fatal error. ' .
