...
class NumberFormatterTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->formatter->setNumberFormatterFactory($this->intlNumberFormatterFactory);
    }
    ...
    /**
     * @param string $style
     * @param int $formatCallsNumber
     */
    private function mockFormat(string $style, int $formatCallsNumber = 1): void
    {
        ...
        $intlNumberFormatter
            ->expects($this->exactly($formatCallsNumber))
            ->method('format')
