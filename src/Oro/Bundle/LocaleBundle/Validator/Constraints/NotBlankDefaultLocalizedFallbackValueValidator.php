 ...
 * for the property in yml. It could be done only in entity annotations which is unconvinient from my point of view,
 ...
 * be more preferable than custom property validation, so this code should be refactored in such a case
 */
