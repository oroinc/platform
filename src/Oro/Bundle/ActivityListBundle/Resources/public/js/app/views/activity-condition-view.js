import choiceTemplate from 'tpl-loader!orofilter/templates/filter/embedded/simple-choice-filter.html';
import $ from 'jquery';
import _ from 'underscore';
import __ from 'orotranslation/js/translator';
import FieldConditionView from 'oroquerydesigner/js/app/views/field-condition-view';
import CustomsetFieldChoiceView from 'oroentity/js/app/views/customset-field-choice-view';
...
import activityConditionTemplate from 'tpl-loader!oroactivitylist/templates/activity-condition.html';
...
export default ActivityConditionView;
