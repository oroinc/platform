...
import ActivityListView from '../views/activity-list-view';
import ActivityModel from '../models/activity-list-model';
import ActivityCollection from '../models/activity-list-collection';
import MultiSelectFilter from 'oro/filter/multiselect-filter';
import DatetimeFilter from 'oro/filter/datetime-filter';
import dataFilterWrapper from 'orofilter/js/datafilter-wrapper';
