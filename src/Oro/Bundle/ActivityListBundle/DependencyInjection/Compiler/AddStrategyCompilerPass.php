...
/**
 * Class AddStrategyCompilerPass
 * @package Oro\Bundle\ActivityListBundle\DependencyInjection\Compiler
 */
class AddStrategyCompilerPass implements CompilerPassInterface
{
    const STRATEGY_TAG = 'oro_activity_list.strategy';
    const DELEGATE_STRATEGY_SERVICE = 'oro_activity_list.strategy.delegate';
