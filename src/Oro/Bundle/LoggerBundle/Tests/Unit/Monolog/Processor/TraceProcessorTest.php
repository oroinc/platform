...
class TraceProcessorTest extends TestCase
{
    ...
    private function createLogRecord(array $context = []): array
    {
        return [
    ...
    public function testRecordWithTraceIdAddsContext(): void
    {
        ...
        self::assertSame($trace, $processedRecord[self::CONTEXT][self::REQUEST_ID_KEY]);
        self::assertSame('bar', $processedRecord[self::CONTEXT]['foo']);
    }
