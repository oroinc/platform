...
namespace Oro\Bundle\LoggerBundle\Tests\Unit\Validator;

use Oro\Bundle\LoggerBundle\Validator\Constraints\EmailRecipientsListConstraint;
use Oro\Bundle\LoggerBundle\Validator\EmailRecipientsListValidator;
...
class EmailRecipientsListValidatorTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testValidateException(): void
    {
        ...
        $this->expectExceptionMessage(
            sprintf('Expected argument of type "%s", "%s" given', EmailRecipientsListConstraint::class, Email::class)
        );
