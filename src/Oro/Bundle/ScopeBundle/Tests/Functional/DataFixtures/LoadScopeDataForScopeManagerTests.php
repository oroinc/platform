...
class LoadScopeDataForScopeManagerTests extends AbstractFixture implements DependentFixtureInterface
{
    ...
    const USER                    = 'user';
    const USER1                   = LoadUserData::SIMPLE_USER;
    const USER2                   = LoadUserData::SIMPLE_USER_2;
    const DEFAULT_SCOPE           = 'default_scope';
    const ORGANIZATION_SCOPE      = 'organization_scope';
    const USER_SCOPE              = 'user_scope';
    const USER1_SCOPE             = 'user1_scope';
    const USER_ORGANIZATION_SCOPE = 'user_organization_scope';
