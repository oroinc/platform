...
import Googlemaps from 'oroaddress/js/mapservice/googlemaps';
import AddressView from 'oroaddress/js/address/view';
import AddressCollection from 'oroaddress/js/address/collection';
