...
class TranslatorCatalogueListenerTest extends TestCase
{
    ...
    private const ADDRESS_TYPE_TRANSLATION_DATA = ["billing", "shipping"];

    private const COUNTRY_TRANSLATION_DATA = ["BR", "BS", "BT", "BV", "BW"];

    private const REGION_TRANSLATION_DATA = ["AD-02", "AD-03", "AD-04", "AD-05", "AD-06"];
