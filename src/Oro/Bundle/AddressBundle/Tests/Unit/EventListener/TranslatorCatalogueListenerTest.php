...
class TranslatorCatalogueListenerTest extends \PHPUnit_Framework_TestCase
{
    /** @var CountryRepository|\PHPUnit_Framework_MockObject_MockObject */
    private $countryRepository;

    /** @var CountryTranslationRepository|\PHPUnit_Framework_MockObject_MockObject */
    private $countryTranslationRepository;

    /** @var RegionRepository|\PHPUnit_Framework_MockObject_MockObject */
    private $regionRepository;

    /** @var RegionTranslationRepository|\PHPUnit_Framework_MockObject_MockObject */
    private $regionTranslationRepository;

    /** @var AddressTypeRepository|\PHPUnit_Framework_MockObject_MockObject */
    private $addressTypeRepository;

    /** @var AddressTypeTranslationRepository|\PHPUnit_Framework_MockObject_MockObject */
