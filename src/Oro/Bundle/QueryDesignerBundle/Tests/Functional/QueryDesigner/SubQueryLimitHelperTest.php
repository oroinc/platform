...
class SubQueryLimitHelperTest extends WebTestCase
{
    ...
    public function testSetLimit(): void
    {
        ...
        self::assertEquals([777], $testQuery->getHint(SubQueryLimitOutputResultModifier::WALKER_HOOK_LIMIT_VALUE));
        self::assertEquals(['id'], $testQuery->getHint(SubQueryLimitOutputResultModifier::WALKER_HOOK_LIMIT_ID));
        self::assertEquals(
            [sprintf('\'%1$s0\' = \'%1$s0\'', SubQueryLimitOutputResultModifier::WALKER_HOOK_LIMIT_KEY)],
