import DatetimeFilterTranslatorToExpression
    from 'oroquerydesigner/js/query-type-converter/to-expression/datetime-filter-translator';
...
describe('oroquerydesigner/js/query-type-converter/to-expression/datetime-filter-translator', () => {
    let translator;
    const filterConfig = {
        type: 'datetime',
        name: 'datetime',
    ...
    beforeEach(() => {
        translator = new DatetimeFilterTranslatorToExpression(filterConfig);
    });
    ...
    describe('translate filter value', () => {
        ...
        const cases = {
            'when value part between start and end datetime': [
                // filterValue
                {
                    type: '1',
                ...
                new BinaryNode(
                    'and',
                    new BinaryNode('>=', createLeftOperand(), new ConstantNode('2018-03-01 00:00')),
                    new BinaryNode('<=', createLeftOperand(), new ConstantNode('2018-03-31 00:00'))
                )
            ],
            'when value part between with empty start datetime and valuable end datetime': [
                {
                    type: '1',
            ...
            'when value part between with valuable start datetime and empty end datetime': [
                {
                    type: '1',
            ...
            'when value part not between start and end datetimes': [
                {
                    type: '2',
                    value: {start: '2018-03-01 00:00', end: '2018-03-31 00:00'},
                    part: 'value'
            ...
            'when value part not between empty start datetime and valuable end datetime': [
                {
                    type: '2',
                    value: {start: '', end: '2018-03-31 00:00'},
                    part: 'value'
            ...
            'when value part not between valuable start datetime and empty end datetime': [
                {
                    type: '2',
                    value: {start: '2018-03-01 00:00', end: ''},
                    part: 'value'
            ...
            'when value part later than the datetime': [
                {
                    type: '3',
                    value: {start: '2018-03-01 00:00', end: ''},
                    part: 'value'
            ...
            'when value part earlier than the datetime': [
                {
                    type: '4',
                    value: {start: '', end: '2018-03-31 00:00'},
                    part: 'value'
            ...
            'when value part equals to the datetime': [
                {
                    type: '5',
                    value: {start: '2018-03-01 00:00', end: ''},
                    part: 'value'
            ...
            'when value part not equals to the datetime': [
                {
                    type: '6',
                    value: {start: '', end: '2018-03-31 00:00'},
                    part: 'value'
