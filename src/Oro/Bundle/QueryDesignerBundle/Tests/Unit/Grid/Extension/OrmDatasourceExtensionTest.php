...
class OrmDatasourceExtensionTest extends OrmTestCase
{
    ...
    protected function setUp()
    {
        ...
        /** @var CalendarFactoryInterface|\PHPUnit\Framework\MockObject\MockObject $calendarFactory */
    ...
    public function testVisitDatasource($source, $expected, $enableGrouping = false)
    {
        ...
        $restrictionBuilder = new RestrictionBuilder($manager);
        $restrictionBuilder->setConfigManager($configManager);
