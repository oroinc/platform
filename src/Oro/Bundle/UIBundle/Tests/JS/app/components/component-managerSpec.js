...
import componentsLoadModule from '../../Fixture/app/components/component-manager/components-loader-mock';
import 'oroui/js/app/modules/component-shortcuts-module';
import 'orofrontend/js/app/modules/component-shortcuts-module';
...
describe('Component Manager', function() {
    beforeEach(function() {
        spyOn(ComponentManager.prototype, '_loadModules')
            .and.callFake(function(module) {
                return jasmine.createSpy().and.callFake(componentsLoadModule)(module);
            });
    });
