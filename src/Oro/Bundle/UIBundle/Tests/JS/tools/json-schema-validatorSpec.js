define(function(require) {
    ...
    describe('oroui/js/tools/json-schema-validator', function() {
        beforeEach(function() {
            jasmine.addMatchers({
                toBeValidJSON: function(util, customEqualityTesters) {
                    return {
                        compare: function(actual, expected) {
                            ...
                            result.message = 'Expected ' + jasmine.pp(data) + (result.pass ? ' not' : '') +
                                ' to be valid against ' + jasmine.pp(schema);
                            return result;
                        }
                    };
                }
        ...
        Object.keys(testSuite).forEach(function(caseName) {
            it(caseName, function() {
                var schema = testSuite[caseName].schema;

                testSuite[caseName].valid.forEach(function(data) {
                    expect(data).toBeValidJSON(schema);
                });

                testSuite[caseName].invalid.forEach(function(data) {
