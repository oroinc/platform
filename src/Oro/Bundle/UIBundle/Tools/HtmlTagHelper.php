...
class HtmlTagHelper implements TranslatorAwareInterface
{
     ...
     */
    public function setCollectErrors(bool $collectErrors = true)
    {
    ...
    public function sanitize($value, $scope = 'default')
    {
        ...
        if (!array_key_exists($scope, $this->htmlPurifiers)) {
            ...
            $config->set('Core.CollectErrors', $this->collectErrors);
        ...
        if ($this->collectErrors && $this->htmlPurifiers[$scope]->context->exists('ErrorCollector')) {
