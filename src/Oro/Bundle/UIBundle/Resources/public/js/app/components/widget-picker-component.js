...
import WidgetPickerFilterModel from 'oroui/js/app/models/widget-picker/widget-picker-filter-model';
import WidgetPickerCollectionView from 'oroui/js/app/views/widget-picker/widget-picker-collection-view';
import WidgetPickerFilterView from 'oroui/js/app/views/widget-picker/widget-picker-filter-view';
...
export default WidgetPickerComponent;
