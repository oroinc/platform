...
define(['underscore', 'backbone', 'oroui/js/mediator', 'oroui/js/loading-mask', 'jquery.form'
    ...
    return Backbone.View.extend({
        options: {
            ...
            alias: null,
            wid: null,
            actionSectionTemplate: _.template('<div data-section="<%= section %>" class="widget-actions-section"></div>'),
            actionWrapperTemplate: _.template('<span class="action-wrapper"></span>'),
