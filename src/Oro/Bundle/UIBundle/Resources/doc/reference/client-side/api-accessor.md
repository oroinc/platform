...
| options.route_parameters_rename_map | <code>Object</code> | Optional. Allows to rename urlParameters which came                                                    into send() function.                                                    Please provide here an object with following structure:                                                    ``` javascript                                                    {                                                      <old-name>: <new-name>                                                    }                                                    ``` |
