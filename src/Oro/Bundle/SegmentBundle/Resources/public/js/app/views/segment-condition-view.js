...
import SegmentFilter from 'orosegment/js/filter/segment-filter';
import AbstractConditionView from 'oroquerydesigner/js/app/views/abstract-condition-view';
import SegmentChoiceView from 'orosegment/js/app/views/segment-choice-view';
...
export default SegmentConditionView;
