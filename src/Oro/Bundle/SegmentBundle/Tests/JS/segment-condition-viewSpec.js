...
import filters from './Fixture/segment-condition/filters.json';
import BaseView from 'oroui/js/app/views/base/view';
import SegmentChoiceMock from './Fixture/segment-condition/segment-choice-mock';
import SegmentConditionView from 'orosegment/js/app/views/segment-condition-view';
