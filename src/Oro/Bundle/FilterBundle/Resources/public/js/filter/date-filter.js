import template from 'tpl-loader!orofilter/templates/filter/date-filter.html';
import fieldTemplate from 'tpl-loader!orofilter/templates/filter/select-field.html';
import dropdownTemplate from 'tpl-loader!orofilter/templates/filter/date-filter-dropdown.html';
import $ from 'jquery';
...
import VariableDatePickerView from 'orofilter/js/app/views/datepicker/variable-datepicker-view';
import DateVariableHelper from 'orofilter/js/date-variable-helper';
import DateValueHelper from 'orofilter/js/date-value-helper';
...
import 'orofilter/js/datevariables-widget';
