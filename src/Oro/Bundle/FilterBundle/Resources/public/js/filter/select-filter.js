import template from 'tpl-loader!orofilter/templates/filter/select-filter.html';
import $ from 'jquery';
import _ from 'underscore';
import __ from 'orotranslation/js/translator';
import TextFilter from 'oro/filter/text-filter';
import {Multiselect, MultiselectDropdown} from 'oroui/js/app/views/multiselect';
