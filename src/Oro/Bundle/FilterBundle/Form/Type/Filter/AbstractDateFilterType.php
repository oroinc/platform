...
abstract class AbstractDateFilterType extends AbstractType
{
    ...
    public function getOperatorChoices()
    {
        return [
            ...
            self::TYPE_MORE_THAN   => $this->translator->trans('oro.filter.form.label_date_type_later_than'),
            self::TYPE_LESS_THAN   => $this->translator->trans('oro.filter.form.label_date_type_earlier_than'),
