...
namespace Oro\Bundle\ActivityBundle\Config\Validation;
    ...
    public function configure(NodeBuilder $nodeBuilder): void
    {
        $nodeBuilder
            ...
            ->scalarNode('show_on_page')
                ->info('`integer` s used to change a page, which will display the “activity list” and activity ' .
                    'buttons. Can be used as bitmask. Possible values are in ' .
