...
class Group extends AbstractPageEntity
{
    ...
    public function __construct($testCase, $redirect = true)
    {
        ...
        $this->name = $this->test->byXpath("//*[starts-with(@id,'oro_user_group_form_name')]");
        $this->owner = $this->test->select($this->test->byXpath("//*[starts-with(@id,'oro_user_group_form_owner')]"));
    }
