...
class RestUsersTest extends WebTestCase
{
    ...
    {
        $this->client->request('DELETE', $this->client->generate('oro_api_delete_user', array('id' => 1)));
        $result = $this->client->getResponse();
    ...
    {
        $this->client->request('GET', $this->client->generate('oro_api_get_user_roles', array('id' => 1)));
        $result = $this->client->getResponse();
        ToolsAPI::assertJsonResponse($result, 200);
        $result = ToolsAPI::jsonToArray($result->getContent());
    ...
    {
        $this->client->request('GET', $this->client->generate('oro_api_get_user_roles', array('id' => 0)));
        $result = $this->client->getResponse();
        ToolsAPI::assertJsonResponse($result, 404);
    }
    ...
    {
        $this->client->request('GET', $this->client->generate('oro_api_get_user_groups', array('id' => 1)));
        $result = $this->client->getResponse();
        ToolsAPI::assertJsonResponse($result, 200);
        $result = ToolsAPI::jsonToArray($result->getContent());
    ...
    {
        $this->client->request('GET', $this->client->generate('oro_api_get_user_groups', array('id' => 0)));
        $result = $this->client->getResponse();
        ToolsAPI::assertJsonResponse($result, 404);
    }
