...
class UserRoleForm extends Form
{
    ...
    /**
     * Fetch capability permissions to array from view page form
     *
     * @return array
     */
    public function getCapabilityPermissions()
    {
        $capabilityBlocks = $this->getPage()->findAll(
            'css',
    ...
    {
        $entityPermissions = $this->getPage()->findAll('css', 'table .entity-permission-container');
        $permissionArray = [];
