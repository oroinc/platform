...
import RolePermissionsActionView from 'orouser/js/datagrid/role-permissions-action-view';
import ActionPermissionsReadonlyRowView from './action-permissions-readonly-row-view';
import AccessLevelsCollection from 'orouser/js/models/role/access-levels-collection';
import FieldView from 'orouser/js/datagrid/action-permissions-field-view';
...
export default ActionPermissionsRowView;
