...
import CapabilitiesView from 'orouser/js/views/role/capabilities-view';
import accessLevels from 'orouser/js/constants/access-levels';
import capabilityCategories from 'orouser/js/constants/capability-categories';
...
export default CapabilitySetComponent;
