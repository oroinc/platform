...
class RolePermissionDatasource extends RolePrivilegeAbstractProvider implements DatasourceInterface
{
    ...
    public function getResults()
    {
        ...
        foreach ($allPrivileges as $key => $privilege) {
            ...
            $item['fields'] = [
                [
                    'identity' => str_replace('entity:', 'field+name:', $item['identity']),
                    'label' => 'name',
                    'entity' => 'name',
                    'permissions' => [
                        [
                ...
                [
                    'identity' => str_replace('entity:', 'field+id:', $item['identity']),
                    'label' => 'id',
                    'entity' => 'id',
                    'permissions' => [
                        [
                ...
                [
                    'identity' => str_replace('entity:', 'field+test:', $item['identity']),
                    'label' => 'test',
                    'entity' => 'test',
                    'permissions' => [
                        [
