...
class AclHelper
{
    ...
    /** @var SearchAclHelperConditionProvider */
    private $aclHelperConditionProvider;
    ...
    public function setAclHelperConditionProvider(SearchAclHelperConditionProvider $aclHelperConditionProvider)
    {
