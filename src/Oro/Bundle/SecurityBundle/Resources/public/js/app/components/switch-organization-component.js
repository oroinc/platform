...
import toolsRouting from 'oronavigation/js/tools/routing';
import modalContentTemplate from 'tpl-loader!orosecurity/templates/organization-modal-content.html';
import BaseComponent from 'oroui/js/app/components/base/component';
import Modal from 'oroui/js/modal';
import interWindowMediator from 'oroui/js/app/services/inter-window-mediator';
import pageStateChecker from 'oronavigation/js/app/services/page-state-checker';
import HighlighterFavicon from 'oroui/js/tools/highlighter/highlighter-favicon';
import HighlighterTitle from 'oroui/js/tools/highlighter/highlighter-title';
...
export default ChangeOrganizationComponent;
