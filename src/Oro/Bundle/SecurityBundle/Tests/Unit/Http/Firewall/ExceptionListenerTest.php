...
class ExceptionListenerTest extends \PHPUnit\Framework\TestCase
{
     ...
     */
    public function testSetTarget(\Exception $exception)
    {
     ...
     * @dataProvider getExceptionProvider
     */
    public function testSetTargetUnsafeMethod(\Exception $exception)
    {
        $event = $this->createEvent($exception);
     ...
     * @dataProvider getExceptionProvider
     */
    public function testSetTargetXmlHttpRequest(\Exception $exception)
    {
        $event = $this->createEvent($exception);
     ...
     */
    public function testShouldSetTargetPathForNonExcludedRoutes($route)
    {
     ...
     * @param string|null $route
     */
    public function testShouldNotSetTargetPathForExcludedRoutes($route)
    {
        $exception = new AccessDeniedException();
        $event = $this->createEvent($exception);
        $request = $event->getRequest();
