...
class SecurityExtensionHelperTest extends \PHPUnit_Framework_TestCase
{
     ...
     * @return \PHPUnit_Framework_MockObject_MockObject|OroContainerBuilder
     */
    protected function getContainerBuilder(array $securityConfig)
    {
        $containerBuilder = $this
            ->getMockBuilder('Oro\Bundle\DistributionBundle\DependencyInjection\OroContainerBuilder')
