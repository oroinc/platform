...
/*</DEBUG>*/
            ...
            function getRequest(request, customData, pluginMethod, currentEcommerceOrderTs) {
                ...
                campaignNameDetected = configCampaignName || attributionCookie[0];
                oldCampaignName = campaignNameDetected;
                campaignKeywordDetected = attributionCookie[1];
                oldCampaignKeyword = campaignKeywordDetected;
                referralTs = attributionCookie[2];
                referralUrl = attributionCookie[3];
                oldReferralUrl = referralUrl;
                ...
                if (!configConversionAttributionFirstReferrer
                    ...
                    if (!campaignNameDetected) {
                        campaignNameDetected = oldCampaignName;
                    }
                    ...
                    if (!campaignKeywordDetected) {
                        campaignKeywordDetected = oldCampaignKeyword;
                    }
                }

                // Set the referral cookie if we have either a Referrer URL, or detected a Campaign (or both)
                if ((referralUrl.length && referralUrl != oldReferralUrl)
                    || (campaignNameDetected.length && campaignNameDetected != oldCampaignName)) {
                    referralTs = nowTs;
                    attributionCookie = [
                        campaignNameDetected,
                        campaignKeywordDetected,
                ...
                request += '&idsite=' + configTrackerSiteId +
                    ...
                    (configUserId ? '&_uid=' + encodeWrapper(configUserId) : '');
...
/*</DEBUG>*/
                 ...
                 */
                setCampaignName: function (campaignName) {
                    configCampaignName = campaignName;
                },
