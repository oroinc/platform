...
class TrackingWebsite extends AbstractPageEntity
{
    ...
    {
        $object = $this->test->byXpath("//*[starts-with(@id,'oro_tracking_website_name')]");
        $object->clear();
        $object->value($name);
    ...
    {
        $object = $this->test->byXpath("//*[starts-with(@id,'oro_tracking_website_identifier')]");
        $object->clear();
    ...
    {
        $object = $this->test->byXpath("//*[starts-with(@id,'oro_tracking_website_url')]");
        $object->clear();
        $object->value($url);
