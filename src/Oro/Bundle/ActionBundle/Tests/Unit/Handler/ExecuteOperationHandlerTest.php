...
class ExecuteOperationHandlerTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->formProvider = $this->getMockBuilder(FormProvider::class)->disableOriginalConstructor()->getMock();
    ...
    public function testProcessSuccess()
    {
        ...
        $executionForm = $this->getMockBuilder(FormInterface::class)->getMock();
        $this->formProvider
            ->expects($this->once())
