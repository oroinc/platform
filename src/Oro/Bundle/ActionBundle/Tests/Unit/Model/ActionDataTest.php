...
class ActionDataTest extends \PHPUnit_Framework_TestCase
{
     ...
     */
    public function testMerge(array $inputData, ActionData $expectedData)
    {
        $inputData['source']->merge($inputData['data']);

        $this->assertEquals($inputData['source']->toArray(), $expectedData->toArray());
    }
    ...
    public function mergeProvider()
    {
        return [
            'empty data' => [
                'input' => [
                    'source' => new ActionData(['param1' => 'val1']),
                    'data' => null,
                ],
                'expected' => new ActionData(['param1' => 'val1']),
            ],
            'no system data' => [
                'input' => [
                    'source' => new ActionData(['param1' => 'val1']),
                    'data' => new ActionData(['param2' => 'val2']),
                ],
                'expected' => new ActionData(['param1' => 'val1']),
            ],
            'full data' => [
                'input' => [
                    'source' => new ActionData([
                        'param1' => 'val1',
                        'redirectUrl' => 'url1',
                        'refreshGrid' => ['grid1']
                    ]),
