...
class FormProvider
{
     ...
     */
    public function getOperationExecutionForm(Operation $operation, ActionData $actionData)
    {
     ...
     */
    public function createTokenData(Operation $operation, ActionData $actionData)
    {
        $tokenId  = $this->getTokenId($operation, $actionData->getOperationToken());
        $options  = ['csrf_token_id'   => $tokenId];
     ...
     * @return string
     */
    protected function getTokenId(Operation $operation, $actionKey)
    {
