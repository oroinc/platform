...
#[Config(defaultValues: ['scope' => ['key' => 'parentValue']])]
class ParentEntity
{
    /**
     * @var string
    ...
    #[ConfigField(mode: 'readonly', defaultValues: ['scope' => ['key' => 'parentValue']])]
    private $parentName;
     ...
     */
    #[ORM\Column(type: 'string', length: 255)]
    #[ConfigField(defaultValues: ['scope' => ['key' => 'parentValue']])]
