...
class AttributesDatagridListenerTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->listener->setLocalizationHelper($this->localizationHelper);
        $this->listener->setAclHelper($this->aclHelper);
        $this->listener->setSecurityChecker($this->securityChecker);
        $this->listener->setUrlGenerator($this->urlGenerator);
    }
