...
{
    /**
     * @deprecated Use getFamiliesLabelsByAttributeIdsWithAcl instead.
     *
     ...
     * @return array
     */
    public function getFamiliesLabelsByAttributeIdsWithAcl(array $attributeIds, AclHelper $aclHelper): array
    {
        if (empty($attributeIds)) {
            return [];
        }
