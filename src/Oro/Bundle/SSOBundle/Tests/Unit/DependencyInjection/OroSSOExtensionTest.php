...
class OroSSOExtensionTest extends ExtensionTestCase
{
    ...
    public function testAddPrefixWithoutBackendPrefixParameter()
    {
        $originalConfig = [
            0 =>[
                'firewalls' => [
        ...
        $this->assertEquals($originalConfig, $containerBuilder->getExtensionConfig('security'));
    }

    public function testAddPrefixWithWrongContainerInstance()
    {
        $containerBuilder = new ContainerBuilder();
        $containerBuilder->setParameter('web_backend_prefix', '/admin');
        ...
        $this->assertEmpty($containerBuilder->getExtensionConfig('security'));
    }
}
