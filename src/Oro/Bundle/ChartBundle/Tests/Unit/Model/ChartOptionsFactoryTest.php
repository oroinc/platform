...
class ChartOptionsFactoryTest extends \PHPUnit\Framework\TestCase
{
    ...
    private function assertBuilder(Report $report): ChartOptionsFactory
    {
        return new ChartOptionsFactory($this->entityFieldProvider, $this->dateHelper, $report, $this->datagrid);
    }
