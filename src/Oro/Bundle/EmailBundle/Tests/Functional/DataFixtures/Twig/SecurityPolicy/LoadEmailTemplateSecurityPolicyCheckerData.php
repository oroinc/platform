...
{
    public const string TEMPLATE_WITH_MODEL_ENTITY_CLASS_REFERENCE = 'security_policy_template_with_model_entity_class';

    /** Name stored in the oro_email_template table used to trigger entityName resolution */
    public const string TEMPLATE_WITH_MODEL_ENTITY_CLASS_NAME = 'security_policy_email_template_model_entity';
