 ...
 * used by the entity-level post-upgrade task tests.
 */
class LoadEmailTemplateForEntityAvailableInTemplateTask extends AbstractFixture
{
    public const string TEMPLATE_REFERENCE = 'email_template_for_entity_available_in_template_task';
