...
class EmailTemplateRenderAfterEventTest extends TestCase
{
    public function testGetters(): void
    {
        $emailTemplate = new EmailTemplateModel('sample_template_name');
        $renderedEmailTemplate = new EmailTemplateModel('rendered_sample_template_name');
        ...
        self::assertSame($renderedEmailTemplate, $event->getRenderedEmailTemplate());
