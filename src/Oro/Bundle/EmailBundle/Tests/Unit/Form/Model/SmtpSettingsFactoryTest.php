...
class SmtpSettingsFactoryTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testCreateFromUserEmailOriginWithoutMcrypt()
    {
        $this->expectException(\InvalidArgumentException::class);
        $smtpSettingsFactory = new SmtpSettingsFactory();
        $smtpSettingsFactory->createFromUserEmailOrigin(new UserEmailOrigin());
    }

    public function testCreateFromUserEmailOriginWithEmptyUserEmailOrigin()
    {
        /** @var Mcrypt|\PHPUnit_Framework_MockObject_MockObject $mcrypt */
        $mcrypt = $this->createMock(Mcrypt::class);
        $smtpSettingsFactory = new SmtpSettingsFactory();
        $smtpSettingsFactory->setMcrypt($mcrypt);
