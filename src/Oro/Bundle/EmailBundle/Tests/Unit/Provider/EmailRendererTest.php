...
class EmailRendererTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->renderer->setEmailTemplateAttachmentProcessor($this->emailTemplateAttachmentProcessor);
    ...
    public function testRenderEmailTemplateWithNullAttachmentProcessor(): void
    {
        // Create renderer without setting attachment processor
        ...
        // Don't set the attachment processor to test BC layer
        ...
        $renderedEmailTemplate = $renderer->renderEmailTemplate(
            $emailTemplate,
            $templateParams,
            $templateContext
        );
        ...
        $renderedAttachments = $renderedEmailTemplate->getAttachments();
        self::assertCount(0, $renderedAttachments);
    }
}
