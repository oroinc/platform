...
class EntityListenerTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->emailActivityUpdates = new EmailActivityUpdates($this->emailOwnersProvider);
        ...
        $container = TestContainerBuilder::create()
            ...
            ->add('oro_email.email.address.manager', $emailAddressManager)
    ...
    public function testOnFlush(): void
    {
        ...
        self::assertSame(
            ...
            ReflectionUtil::getPropertyValue($this->listener, 'createdEmails')
        );
        self::assertSame(
        ...
        self::assertSame(
            $this->getHashedArray($createdEmails),
            ReflectionUtil::getPropertyValue($this->listener, 'activityManagerEmails')
        );
        self::assertSame(
        ...
        self::assertSame(
            ...
            ReflectionUtil::getPropertyValue($this->emailActivityUpdates, 'updatedEmailAddresses')
        );
        self::assertSame(
            $processedAddresses,
