            ...
            ->will(
                $this->returnValueMap(
                    ...
                    [
                        ...
                        ['oro_email.util.transport_updater', 1, $this->configurableTransport],
                    ]
                )
            );
            ...
            ->will(
                $this->returnValueMap(
                    [
                        ...
                        ['oro_email.util.configurable_transport', 1, $this->configurableTransport],
                    ]
                )
            );

        new DirectMailer($this->baseMailer, $this->container);
    }
