...
final class SafeGetAttrNodeTest extends TestCase
{
    ...
    public function testAttributeReturnsFalseForDefinedTestOnDeniedMethodAccess(): void
    {
        $object = new class () {
            public function secret(): string
            {
    ...
    public function testAttributeReturnsFalseForDefinedTestOnDeniedPropertyAccess(): void
    {
        $object = new class () {
            public string $secretProp = 'secret-value';
        };
