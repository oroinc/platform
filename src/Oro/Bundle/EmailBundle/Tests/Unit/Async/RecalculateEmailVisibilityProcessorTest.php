...
class RecalculateEmailVisibilityProcessorTest extends OrmTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->processor = new RecalculateEmailVisibilityProcessor(
            $doctrine,
            $this->createMock(EmailAddressVisibilityManager::class),
            $this->createMock(ActivityListChainProvider::class),
            $this->logger
        );
        $this->processor->setJobRunner($this->jobRunner);
        $this->processor->setProducer(self::getMessageProducer());
    }
    ...
    {
        self::assertEquals(
            [Topics::RECALCULATE_EMAIL_VISIBILITY],
    ...
    public function testProcessWhenEmailsNotFound(): void
    {
        ...
        self::assertMessagesEmpty(Topics::RECALCULATE_EMAIL_VISIBILITY_CHUNK);
    }
