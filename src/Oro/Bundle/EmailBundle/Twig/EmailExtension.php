...
class EmailExtension extends AbstractExtension implements ServiceSubscriberInterface
{
    ...
    public function getEmailThreadAttachments($thread)
    {
        ...
        $repo = $this->getDoctrine()->getRepository(EmailAttachment::class);
    ...
    public function getUnreadEmailsCount()
    {
        ...
        $repo = $this->getDoctrine()->getRepository(Email::class);
    ...
    {
        return [
            EmailHolderHelper::class,
            EmailAddressHelper::class,
            EmailAttachmentManager::class,
            MailboxProcessStorage::class,
            RelatedEmailsProvider::class,
            UrlProvider::class,
    ...
    private function getEmailHolderHelper(): EmailHolderHelper
    {
        return $this->container->get(EmailHolderHelper::class);
    }

    private function getEmailAddressHelper(): EmailAddressHelper
    {
        return $this->container->get(EmailAddressHelper::class);
    }
    ...
    private function getMailboxProcessStorage(): MailboxProcessStorage
    {
        return $this->container->get(MailboxProcessStorage::class);
    }

    private function getRelatedEmailsProvider(): RelatedEmailsProvider
    {
        return $this->container->get(RelatedEmailsProvider::class);
    }

    private function getUrlProvider(): UrlProvider
    {
        return $this->container->get(UrlProvider::class);
    }
    ...
    private function getEmailTemplateCandidatesProvider(): EmailTemplateCandidatesProviderInterface
    {
        return $this->container->get(EmailTemplateCandidatesProviderInterface::class);
    }

    private function getEmailTemplateRenderingContext(): EmailTemplateRenderingContext
    {
