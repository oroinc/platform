...
/**
 * Email-template-aware property violation. Extends the generic {@see SecurityPolicyPropertyViolation}
 * with the name of the email template field where the violation was detected.
 */
final class EmailTemplateSecurityPolicyPropertyViolation extends SecurityPolicyPropertyViolation implements
