...
/**
 * Email-template-aware function violation. Extends the generic {@see SecurityPolicyFunctionViolation}
 * with the name of the email template field where the violation was detected.
 */
final class EmailTemplateSecurityPolicyFunctionViolation extends SecurityPolicyFunctionViolation implements
