...
{
    protected static $defaultName = 'oro:email:template:security-policy-check';
    protected static $defaultDescription = 'Checks email templates for Twig sandbox security policy violations.';
