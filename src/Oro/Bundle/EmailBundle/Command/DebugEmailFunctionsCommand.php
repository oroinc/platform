...
{
    protected static $defaultName = 'oro:debug:email:functions';
    protected static $defaultDescription = 'Displays all Twig functions registered for the email template sandbox.';
