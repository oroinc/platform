...
{
    protected static $defaultName = 'oro:debug:email:template:entities';
    protected static $defaultDescription = 'Lists entity classes by their email template availability status.';
