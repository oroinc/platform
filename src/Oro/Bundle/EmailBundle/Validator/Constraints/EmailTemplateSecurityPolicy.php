...
{
    public const string NOT_ALLOWED_TAG_ERROR = '0980d6f8-639d-46e8-a312-859b1e1377b9';
    public const string NOT_ALLOWED_FILTER_ERROR = '5ffb1775-99b6-4e7b-a016-45e31ca732b0';
    public const string NOT_ALLOWED_FUNCTION_ERROR = 'feeb05f7-b2ec-490c-822d-7dcd87938538';
    public const string NOT_ALLOWED_PROPERTY_ERROR = '104740e8-2b2a-4165-aae4-6714bdc4bcec';
    public const string NOT_ALLOWED_METHOD_ERROR = 'b5d5e3b2-5e87-4d60-b639-3a91d9ae641a';
