...
class EmailTemplateSelectType extends AbstractType
{
    ...
    public function finishView(FormView $view, FormInterface $form, array $options)
    {
        ...
        $view->vars['includeNonEntity'] = (bool)$config->getOption('include_non_entity_templates');
        $view->vars['includeSystemTemplates'] = (bool)$config->getOption('include_system_templates');
    }
