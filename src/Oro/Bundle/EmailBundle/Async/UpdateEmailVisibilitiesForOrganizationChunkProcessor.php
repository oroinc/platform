...
/**
 * Updates visibilities for specific emails in a specific organization.
 */
    ...
    TopicSubscriberInterface
{
    ...
    {
        return [Topics::UPDATE_EMAIL_VISIBILITIES_FOR_ORGANIZATION_CHUNK];
    }
    ...
    public function process(MessageInterface $message, SessionInterface $session)
    {
        ...
        if (!isset($body['jobId'], $body['organizationId'], $body['firstEmailId'])) {
        ...
        $result = $this->jobRunner->runDelayed(
            $body['jobId'],
            function () use ($body) {
                $this->processJob($body['organizationId'], $body['firstEmailId'], $body['lastEmailId'] ?? null);
