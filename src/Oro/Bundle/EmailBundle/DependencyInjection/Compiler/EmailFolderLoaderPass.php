...
class EmailFolderLoaderPass implements CompilerPassInterface
{
    const SERVICE_KEY = 'oro_email.email_folder_loader_selector';
    const TAG = 'oro_email.email_folder_loader';
