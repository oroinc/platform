...
class EmailFlagManagerLoaderPass implements CompilerPassInterface
{
    const SERVICE_KEY = 'oro_email.email_flag_manager_loader_selector';
    const TAG = 'oro_email.email_flag_manager_loader';
