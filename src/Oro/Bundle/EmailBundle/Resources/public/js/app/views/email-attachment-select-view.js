...
import $ from 'jquery';
import EmailAttachmentListRowView from 'oroemail/js/app/views/email-attachment-list-row-view';
import BaseCollectionView from 'oroui/js/app/views/base/collection-view';
import template from 'tpl-loader!oroemail/templates/email-attachment/email-attachment-select-view.html';
...
export default EmailAttachmentSelectView;
