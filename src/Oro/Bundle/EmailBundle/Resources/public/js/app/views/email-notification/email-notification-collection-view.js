...
import emailsGridRouteBuilder from 'oroemail/js/util/emails-grid-route-builder';
import EmailNotificationView from './email-notification-item-view';
...
import template from 'tpl-loader!oroemail/templates/email-notification/email-notification-collection-view.html';
...
export default EmailNotificationCollectionView;
