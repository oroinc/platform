...
/**
 * Entity config validation configuration for `email` section.
 */
class EmailEntityConfiguration implements EntityConfigInterface
{
    #[\Override]
    ...
    public function configure(NodeBuilder $nodeBuilder): void
    {
        $nodeBuilder
            ->node('available_in_template', 'normalized_boolean')
                ->info('`boolean` if set to true, the entity can be used in email templates.')
                ->defaultFalse()
            ->end()
