...
import popup from 'oroimap/js/app/components/oauth-popup';
import BaseImapComponent from 'oroimap/js/app/components/imap-component';
import ImapMicrosoftView from 'oroimap/js/app/views/imap-microsoft-view';
...
export default ImapMicrosoftComponent;
