...
import CheckConnectionView from '../views/check-connection-view';
import CheckConnectionModel from '../models/check-connection-model';
...
export default CheckConnectionComponent;
