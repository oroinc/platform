...
import CommentFromView from 'orocomment/js/app/views/comment-form-view';
import CommentsView from 'orocomment/js/app/views/comments-view';
import CommentCollection from 'orocomment/js/app/models/comment-collection';
