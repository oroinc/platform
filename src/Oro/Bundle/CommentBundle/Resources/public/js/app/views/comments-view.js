...
import CommentsHeaderView from 'orocomment/js/app/views/comments-header-view';
import CommentsNoDataView from 'orocomment/js/app/views/comments-no-data-view';
import CommentItemView from 'orocomment/js/app/views/comment-item-view';
import BaseCollectionView from 'oroui/js/app/views/base/collection-view';
import template from 'text-loader!orocomment/templates/comment/comments-view.html';
