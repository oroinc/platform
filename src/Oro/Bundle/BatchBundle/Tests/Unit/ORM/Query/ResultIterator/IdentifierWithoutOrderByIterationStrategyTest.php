...
class IdentifierWithoutOrderByIterationStrategyTest extends TestCase
{
    private IdentifierWithoutOrderByIterationStrategy $strategy;

    #[\Override]
    protected function setUp(): void
    {
        $this->strategy = new IdentifierWithoutOrderByIterationStrategy();
    }
    ...
    public function testInitializeIdentityQuerySetsCustomHydrationMode(): void
    {
        ...
        self::assertContains(ReduceOrderByWalker::class, $query->getHint(Query::HINT_CUSTOM_TREE_WALKERS));
        self::assertContains(SelectIdentifierWalker::class, $query->getHint(Query::HINT_CUSTOM_TREE_WALKERS));
    }
