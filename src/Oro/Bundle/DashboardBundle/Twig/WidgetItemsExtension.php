...
class WidgetItemsExtension extends Twig_Extension
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            new Twig_SimpleFilter('oro_dashboard_filter_widget_items', [$this, 'filterItems']),
        ];
    }
    ...
    {
        return 'oroc_dashboard.widget_items';
    }
}
