...
import DashboardItemWidget from 'orodashboard/js/widget/dashboard-item';
import dashboardUtil from 'orodashboard/js/dashboard-util';
import ConfigurationWidget from 'orodashboard/js/widget/configuration-widget';
import WidgetPickerModal from 'orodashboard/js/widget-picker-modal';
