    ...
    public function onBuildAfter(BuildAfter $event)
    {
        ...
        if ($datasource instanceof OrmDatasource) {
            ...
            if (in_array('objectId', $this->paramsToBind)) {
                $queryParameters['objectId'] = (int) $parameters->get(self::GRID_PARAM_OBJECT_ID, 0);
            }

            if (in_array('entityId', $this->paramsToBind)) {
                $queryParameters['entityId'] = (string) $parameters->get(self::GRID_PARAM_OBJECT_ID, 0);
            }
