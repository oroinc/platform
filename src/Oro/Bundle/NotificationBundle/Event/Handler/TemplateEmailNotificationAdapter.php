...
/**
 * Adapts EmailNotificationAdapter to TemplateEmailNotificationInterface required for email notifications processor
 * to send localized emails.
 */
class TemplateEmailNotificationAdapter extends EmailNotificationAdapter implements TemplateEmailNotificationInterface
{
    /**
    ...
    public function __construct(
        ...
        parent::__construct($entity, $notification, $em, $propertyAccessor);
