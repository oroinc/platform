...
class TransactionEmail extends AbstractPageEntity
{
    ...
    public function __construct($testCase, $redirect = true)
    {
        ...
        $this->entityName = $this->test
            ->select($this->test->byXpath("//*[starts-with(@id,'emailnotification_entityName')]"));
        $this->event = $this->test->select($this->test->byXpath("//*[starts-with(@id,'emailnotification_event')]"));
        ...
        $this->groups = $this->test->byXpath("//*[starts-with(@id,'emailnotification_recipientList_groups')]");
        $this->email = $this->test->byXpath("//*[starts-with(@id,'emailnotification_recipientList_email')]");
    }
