...
class JobManagerTest extends WebTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->jobStorage = self::getContainer()->get('oro_message_queue.job.storage');
    ...
    public function testCancelChildJobsWithStatusNew(): void
    {
        ...
        $this->getEntityManager()->clear(Job::class);
        $childJob1 = $this->getEntityManager()->find(Job::class, $childJob1->getId());
        ...
        $childJob2 = $this->getEntityManager()->find(Job::class, $childJob2->getId());
    ...
    public function testCancelChildJobsWithStatusRunning(): void
    {
        ...
        $this->getEntityManager()->clear(Job::class);
        $childJob = $this->getEntityManager()->find(Job::class, $childJob->getId());
