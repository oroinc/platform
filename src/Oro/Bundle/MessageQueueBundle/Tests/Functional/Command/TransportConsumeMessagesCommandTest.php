...
final class TransportConsumeMessagesCommandTest extends WebTestCase
{
    ...
    private const COMMAND = 'oro:message-queue:transport:consume';

    private const QUEUE_HIGH = 'oro.test.priority.high';
    private const QUEUE_MEDIUM = 'oro.test.priority.medium';
