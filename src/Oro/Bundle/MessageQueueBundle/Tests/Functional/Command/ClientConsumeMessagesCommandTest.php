...
final class ClientConsumeMessagesCommandTest extends WebTestCase
{
    ...
    private const COMMAND = 'oro:message-queue:consume';

    private const CLIENT_QUEUE_HIGH = 'test.priority.high';
    private const CLIENT_QUEUE_MEDIUM = 'test.priority.medium';
    private const CLIENT_QUEUE_LOW = 'test.priority.low';

    private const TRANSPORT_QUEUE_HIGH = 'oro.test.priority.high';
    private const TRANSPORT_QUEUE_MEDIUM = 'oro.test.priority.medium';
    private const TRANSPORT_QUEUE_LOW = 'oro.test.priority.low';
