...
final class MergeEvents
{
     ...
     */
    public const BEFORE_MERGE_ENTITY = 'oro.entity_merge.before_merge_entity';

    /**
     * The AFTER_MERGE_ENTITY event occurs at the end of merge.
     * Instance of Oro\Bundle\EntityMergeBundle\Event\EntityDataEvent is passed.
     */
    public const AFTER_MERGE_ENTITY = 'oro.entity_merge.after_merge_entity';
     ...
     */
    public const BEFORE_MERGE_FIELD = 'oro.entity_merge.before_merge_field';

    /**
     * The AFTER_MERGE_FIELD event occurs at the end of merging field.
     * Instance of Oro\Bundle\EntityMergeBundle\Event\FieldDataEvent is passed.
     */
    public const AFTER_MERGE_FIELD = 'oro.entity_merge.after_merge_field';
     ...
     */
    public const BUILD_METADATA = 'oro.entity_merge.build_metadata';

    /**
     * The CREATE_ENTITY_DATA event occurs at EntityData creation.
     * Instance of Oro\Bundle\EntityMergeBundle\Event\EntityDataEvent is passed.
     */
    public const CREATE_ENTITY_DATA = 'oro.entity_merge.create_entity_data';
     ...
     */
    public const BEFORE_VALUE_RENDER = 'oro.entity_merge.before_value_render';
}
