...
final class WorkflowTransitionMaskBuilder extends MaskBuilder
{
    ...
    public const MASK_PERFORM_TRANSITION_GLOBAL = 8;  // 1 << 4

    // These access levels give a user access to all workflow transitions within the system.
    public const MASK_PERFORM_TRANSITION_SYSTEM = 16; // 1 << 5

    public const GROUP_BASIC  = 1;  // 0x1
    public const GROUP_LOCAL  = 2;  // 0x2
    public const GROUP_DEEP   = 4;  // 0x2
    public const GROUP_GLOBAL = 8;  // 0x8
    public const GROUP_SYSTEM = 16; // 0x10

    public const GROUP_PERFORM_TRANSITION = 31; // 0x1F
    public const GROUP_NONE               = 0;  // 0x0
    public const GROUP_ALL                = 31; // 0x1F

    public const CODE_PERFORM_TRANSITION = 'P';

    protected const PATTERN_ALL_OFF = '(P) system:. global:. deep:. local:. basic:.';
