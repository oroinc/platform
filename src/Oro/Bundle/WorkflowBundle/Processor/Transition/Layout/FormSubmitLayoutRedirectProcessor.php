...
{
    private ?SameSiteUrlHelper $sameSiteUrlHelper = null;

    public function setSameSiteUrlHelper(?SameSiteUrlHelper $sameSiteUrlHelper): void
    {
    ...
    protected function lookUpRedirectUrl(TransitionContext $context)
    {
        ...
        yield $this->sameSiteUrlHelper
            ? $this->sameSiteUrlHelper->getSameSiteReferer($request)
