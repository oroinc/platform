...
import HistoryNavigationComponent from 'oroui/js/app/components/history-navigation-component';
import FlowchartEditorWorkflowView from '../views/flowchart/editor/workflow-view';
...
import WorkflowManagementView from '../views/workflow-management-view';
import TransitionModel from '../models/transition-model';
import TransitionEditFormView from '../views/transition/transition-edit-view';
import StepEditView from '../views/step/step-edit-view';
import StepModel from '../models/step-model';
import workflowModelFactory from '../../tools/workflow-model-factory';
