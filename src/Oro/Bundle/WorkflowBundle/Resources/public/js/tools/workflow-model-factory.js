...
import AttributeCollection from 'oroworkflow/js/app/models/attribute-collection';
import StepCollection from 'oroworkflow/js/app/models/step-collection';
import StepModel from 'oroworkflow/js/app/models/step-model';
import TransitionCollection from 'oroworkflow/js/app/models/transition-collection';
import TransitionDefinitionCollection from 'oroworkflow/js/app/models/transition-definition-collection';
import WorkflowModel from 'oroworkflow/js/app/models/workflow-model';
