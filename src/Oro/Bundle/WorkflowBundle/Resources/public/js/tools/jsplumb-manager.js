...
import Matrix from './jsplumb-manager/jpm-matrix';
import HideStartRule from './jsplumb-manager/jpm-hide-start-rule';
import CascadeRule from './jsplumb-manager/jpm-cascade-rule';
import PyramidRule from './jsplumb-manager/jpm-pyramid-rule';
import TriadaRule from './jsplumb-manager/jpm-triada-rule';
import CherryRule from './jsplumb-manager/jpm-cherry-rule';
const mids = {
    top: [0.5, 0, 0, -1],
    bottom: [0.5, 1, 0, 1],
    left: [0, 0.5, -1, 0],
