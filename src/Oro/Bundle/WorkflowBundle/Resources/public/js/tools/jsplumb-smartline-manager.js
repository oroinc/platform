import JsPlumbOverlayManager from './jsplumb-overlay-manager';
import _ from 'underscore';
import Graph from './path-finder/graph';
import Rectangle from './path-finder/rectangle';
import finderSettings from './path-finder/settings';
import Finder from './path-finder/finder';
import directions from './path-finder/directions';
...
export default JsPlumbSmartlineManager;
