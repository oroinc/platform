...
* **massStartWorkflow(data)** - starts several workflows in one transaction, receives set of WorkflowStartArguments instances that contains workflow itself, entity, transition (optional) and workflow data (optional);
