...
At the first implement your resolver. It must implement [RouteOptionsResolverInterface](/Routing/Resolver/RouteOptionsResolverInterface.php). For example:
...
Sometime you need to hide some route from Symfony URL Matcher and documentation generated by NelmioApiDocBundle, but keep it available in Symfony URL Generator. For example if you have same common route for some kind of entities and you use a route options resolver to create routes for concrete entities based on the common route.
