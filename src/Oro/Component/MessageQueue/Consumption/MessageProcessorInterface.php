...
interface MessageProcessorInterface
{
     ...
     */
    public const ACK = 'oro.message_queue.consumption.ack';

    /**
     * Use this constant when the message is not valid or could not be processed
     * The message is removed from the queue
     */
    public const REJECT = 'oro.message_queue.consumption.reject';
     ...
     */
    public const REQUEUE = 'oro.message_queue.consumption.requeue';
