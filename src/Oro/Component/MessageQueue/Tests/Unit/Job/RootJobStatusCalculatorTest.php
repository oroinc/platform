...
class RootJobStatusCalculatorTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->rootJobStatusCalculator->setRegistry($this->registry);
    ...
    public function testCalculateChildJobsWithStop(): void
    {
        ...
        $rootJob = $this->getJob('Root Job', Job::STATUS_NEW, 1);
        $child1 = $this->getJob('Child Job 1', null, null, $rootJob);
        $child2 = $this->getJob('Child Job 2', null, null, $rootJob);
