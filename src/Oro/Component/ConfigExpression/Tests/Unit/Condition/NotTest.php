...
class NotTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertSame($this->condition, $this->condition->initialize([new Condition\TrueCompatible()]));
        $this->assertFalse($this->condition->evaluate('anything'));

        $this->assertSame($this->condition, $this->condition->initialize([new Condition\FalseCompatible()]));
    ...
    public function testEvaluateWithErrors()
    {
        ...
        $trueConditionWithError = new Condition\TrueCompatible();
