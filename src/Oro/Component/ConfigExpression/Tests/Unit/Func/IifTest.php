...
class IifTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function evaluateDataProvider()
    {
        return [
            'true_expr'        => [
                'options'        => [new Condition\TrueCompatible(), new PropertyPath('foo'), new PropertyPath('bar')],
                'context'        => ['foo' => 'true', 'bar' => 'false'],
                'expectedResult' => 'true'
            ],
            'false_expr'       => [
                'options'        => [new Condition\FalseCompatible(), new PropertyPath('foo'), new PropertyPath('bar')],
                'context'        => ['foo' => 'true', 'bar' => 'false'],
