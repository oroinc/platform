    ...
    public function queryModificationProvider()
    {
        return [
            ...
            'whole entity in SELECT, join, no ORDER BY'                   => [
                ...
                'SELECT p0_.id AS id_0, p0_.name AS name_1, i1_.id AS id_2,'
                . ' p0_.bestItem_id AS bestItem_id_3, i1_.owner_id AS owner_id_4'
            ...
            'whole entity in SELECT, DISTINCT, join, no ORDER BY'         => [
                ...
                'SELECT DISTINCT p0_.id AS id_0, p0_.name AS name_1, i1_.id AS id_2,'
                . ' p0_.bestItem_id AS bestItem_id_3, i1_.owner_id AS owner_id_4'
                . ' FROM Person p0_ INNER JOIN Item i1_ ON p0_.bestItem_id = i1_.id'
                . ' ORDER BY p0_.id ASC',
            ],
            ...
            'partial SELECT, no ORDER BY'                                 => [
                ...
                'SELECT p0_.id AS id_0, p0_.bestItem_id AS bestItem_id_1 FROM Person p0_ ORDER BY p0_.id ASC',
            ],
            ...
            'partial SELECT, DISTINCT, no ORDER BY'                       => [
                ...
                'SELECT DISTINCT p0_.id AS id_0, p0_.bestItem_id AS bestItem_id_1'
                . ' FROM Person p0_ ORDER BY p0_.id ASC',
            ],
        ];
    }
