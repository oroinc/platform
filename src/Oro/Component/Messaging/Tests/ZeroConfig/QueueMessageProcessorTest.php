...
class QueueMessageProcessorTest extends \PHPUnit_Framework_TestCase
{
    public function testCouldBeConstructedWithRequiredArguments()
    {
        new QueueMessageProcessor($this->createMessageProcessorRegistryMock());
    }
    ...
    public function testShouldProcessMessage()
    {
        ...
        $processor = new QueueMessageProcessor($processorRegistry);
