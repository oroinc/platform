...
use Oro\Component\Messaging\ZeroConfig\ContainerAwareMessageProcessorRegistry;
...
class ContainerAwareMessageProcessorRegistryTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->setExpectedException(\LogicException::class, 'MessageProcessor was not found. processorName: "processor-name"');
