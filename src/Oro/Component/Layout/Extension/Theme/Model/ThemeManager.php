...
{
    private const CACHE_THEME_OPTION_KEY = 'oro_theme.option';
    private const CACHE_THEME_CONFIG_OPTION_KEY = 'oro_theme.config_option';
    private const INHERITED_THEME_CONFIG_NAMESPACE = 'config.';
