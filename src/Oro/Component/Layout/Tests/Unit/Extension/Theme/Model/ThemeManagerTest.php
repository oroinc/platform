...
final class ThemeManagerTest extends TestCase
{
    ...
    private function createManager(
        ...
        $themeManager->setEventDispatcher($this->dispatcher);
        $themeManager->setThemeManagerCache($this->cache);
        $themeManager->setPropertyAccessor($this->propertyAccessor);
        $themeManager->setInheritedThemeOptions($inheritedThemeOptions);
