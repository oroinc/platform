...
final class ThemeConfigOptionGetEventTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->event = new ThemeConfigOptionGetEvent($this->themeManager, 'default', 'template');
    }
    ...
    public function testIsInherited(): void
    {
        ...
        $event = new ThemeConfigOptionGetEvent($this->themeManager, 'default', 'template', false);
