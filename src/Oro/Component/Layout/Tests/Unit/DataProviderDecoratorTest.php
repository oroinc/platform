...
class DataProviderDecoratorTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->decorator = new DataProviderDecorator(
            new DataProviderStub(['key1' => 'value1']),
            ['get', 'has', 'is']
        );
    }
    ...
    public function testCallForGetMethod()
    {
        ...
        $this->expectExceptionMessage(
            'Method "get" cannot be called. The method name should start with "get", "has", "is".'
        );
    ...
    public function testCallForHasMethod()
    {
        $this->expectException(\BadMethodCallException::class);
        $this->expectExceptionMessage(
            'Method "has" cannot be called. The method name should start with "get", "has", "is".'
        );
    ...
    public function testCallForIsMethod()
    {
        $this->expectException(\BadMethodCallException::class);
        $this->expectExceptionMessage(
            'Method "is" cannot be called. The method name should start with "get", "has", "is".'
        );
    ...
    public function testCallForNotAllowedMethod()
    {
        $this->expectException(\BadMethodCallException::class);
        $this->expectExceptionMessage(
            'Method "set" cannot be called. The method name should start with "get", "has", "is".'
        );
    ...
    public function testCallForMethodWithNotAllowedPrefix()
    {
        $this->expectException(\BadMethodCallException::class);
        $this->expectExceptionMessage(
            'Method "setValue" cannot be called. The method name should start with "get", "has", "is".'
        );
